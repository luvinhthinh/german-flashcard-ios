  ...
  static final Map<String, List<Map<String, dynamic>>> _letterOptions = {
    ...
    'B': [
      ...
      },
      {
        ...
        'gifFile': 'b_ball.gif',
        'audioFiles': ['b_ball_soundeffect_de.wav', 'b_ball_longtext_de.mp3'],
    ...
    'D': [
      {
        ...
        'audioFiles': ['d_dinosaurier_soundeffect_de.wav', 'd_dinosaurierlongtext_de.mp3'],
    ...
    'E': [
      {
        ...
        'audioFiles': ['e_elefant_soundeffect_de.mp3', 'e_elefant_longtext_de.mp3'],
        'pronunciationAudio': 'e_elefant_pronunciation_de.mp3',
      },
      {
        'word': 'Eule',
        'pronunciation': 'oy-le',
    ...
    'F': [
      {
        ...
        'gifFile': 'f_fisch.gif',
        'audioFiles': ['f_fisch_soundeffect_de.mp3', 'f_fisch_longtext_de.mp3'],
        'pronunciationAudio': 'f_fisch_pronunciation_de.mp3',
      },
      {
        'word': 'Frosch',
        'pronunciation': 'frosh',
    ...
    'G': [
      {
        ...
        'audioFiles': ['g_giraffe_soundeffect_de.mp3', 'g_giraffe_longtext_de.mp3'],
        'pronunciationAudio': 'g_giraffe_pronunciation_de.mp3',
      },
      {
        'word': 'Gans',
        'pronunciation': 'gahns',
    ...
    'H': [
      {
        ...
        'gifFile': 'h_haus.gif',
        'audioFiles': ['h_haus_soundeffect_de.mp3', 'h_haus_longtext_de.mp3'],
        'pronunciationAudio': 'h_haus_pronunciation_de.mp3',
      },
      {
        'word': 'Hund',
        'pronunciation': 'hoont',
    ...
    'I': [
      {
        ...
        'gifFile': 'i_igel.gif',
        'audioFiles': ['i_igel_soundeffect_de.mp3', 'i_igel_longtext_de.mp3'],
        'pronunciationAudio': 'i_igel_pronunciation_de.mp3',
      },
      {
        'word': 'Insel',
    ...
    'J': [
      {
        ...
        'gifFile': 'j_jacke.gif',
        'audioFiles': ['j_jacke_soundeffect_de.mp3', 'j_jacke_longtext_de.mp3'],
        'pronunciationAudio': 'j_jacke_pronunciation_de.mp3',
      },
      {
        'word': 'Junge',
    ...
    'K': [
      {
        ...
        'gifFile': 'k_katze.gif',
        'audioFiles': ['k_katze_soundeffect_de.mp3', 'k_katze_longtext_de.mp3'],
        'pronunciationAudio': 'k_katze_pronunciation_de.mp3',
      },
      {
        'word': 'Kuh',
        'pronunciation': 'koo',
    ...
    'L': [
      {
        ...
        'gifFile': 'l_loewe.gif',
        'audioFiles': ['l_loewe_soundeffect_de.mp3', 'l_loewe_longtext_de.mp3'],
        'pronunciationAudio': 'l_loewe_pronunciation_de.mp3',
      },
      {
        'word': 'Lamm',
        'pronunciation': 'lahm',
    ...
    'O': [
      {
        ...
        'audioFiles': ['o_orange_soundeffect_de.mp3', 'o_orange_longtext_de.mp3'],
        'pronunciationAudio': 'o_orange_pronunciation_de.mp3',
      },
      {
        'word': 'Oktopus',
    ...
    'P': [
      {
        ...
        'audioFiles': ['p_pinguin_soundeffect_de.mp3', 'p_pinguin_longtext_de.mp3'],
        'pronunciationAudio': 'p_pinguin_pronunciation_de.mp3',
      },
      {
        'word': 'Pferd',
        'pronunciation': 'pfert',
    ...
    'Q': [
      {
        ...
        'audioFiles': ['q_qualle_soundeffect_de.mp3', 'q_qualle_longtext_de.mp3'],
        'pronunciationAudio': 'q_qualle_pronunciation_de.mp3',
      },
    ],
    'R': [
      {
        ...
        'gifFile': 'r_rose.gif',
        'audioFiles': ['r_rose_soundeffect_de.mp3', 'r_rose_longtext_de.mp3'],
        'pronunciationAudio': 'r_rose_pronunciation_de.mp3',
      },
      {
        'word': 'Regenbogen',
    ...
    'S': [
      {
        ...
        'gifFile': 's_sonne.gif',
        'audioFiles': ['s_sonne_soundeffect_de.mp3', 's_sonne_longtext_de.mp3'],
        'pronunciationAudio': 's_sonne_pronunciation_de.mp3',
      },
      {
        'word': 'Schlange',
    ...
    'T': [
      {
        ...
        'gifFile': 't_tiger.gif',
        'audioFiles': ['t_tiger_soundeffect_de.mp3', 't_tiger_longtext_de.mp3'],
        'pronunciationAudio': 't_tiger_pronunciation_de.mp3',
      },
      {
        'word': 'Taube',
    ...
    'U': [
      {
        ...
        'imageFile': 'u_uhr.png',
        'gifFile': 'u_uhr.gif',
        'audioFiles': ['u_uhr_soundeffect_de.mp3', 'u_uhr_longtext_de.mp3'],
        'pronunciationAudio': 'u_uhr_pronunciation_de.mp3',
      }
    ],
    'V': [
      {
        ...
        'gifFile': 'v_vogel.gif',
        'audioFiles': ['v_vogel_soundeffect_de.mp3', 'v_vogel_longtext_de.mp3'],
        'pronunciationAudio': 'v_vogel_pronunciation_de.mp3',
      },
      {
        'word': 'Veilchen',
    ...
    'W': [
      {
        ...
        'audioFiles': ['w_wasser_soundeffect_de.mp3', 'w_wasser_longtext_de.mp3'],
        'pronunciationAudio': 'w_wasser_pronunciation_de.mp3',
      },
      {
        'word': 'Wal',
        'pronunciation': 'vahl',
    ...
    'X': [
      {
        ...
        'audioFiles': ['x_xylophon_soundeffect_de.mp3', 'x_xylophon_longtext_de.mp3'],
        'pronunciationAudio': 'x_xylophon_pronunciation_de.mp3',
      },
    ],
    'Y': [
      {
